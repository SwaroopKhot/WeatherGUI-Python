...
def get_weather(city):
	weather_key = '3d125e94234404d03460265b7b631d29' # Paste Your own ID from OpenWeathermap site.....
...
frame = tk.Frame(root, bg="#d9d9d9", bd=4)
frame.place(relwidth=0.75, relx=0.5, rely=0.1, relheight=0.1, anchor='n')

entry= tk.Entry(frame, font=40)
entry.place(relwidth=0.65, relheight=1)

button = tk.Button(frame, bg='#990099', text = "Get Weather", font=40, command=lambda: get_weather(entry.get()))
button.place(relwidth=0.3, relx=0.7, relheight=1)

lower_frame = tk.Frame(root, bg="#d9d9d9", bd=6)
